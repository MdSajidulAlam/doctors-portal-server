...
async function run() {
    try {
        ...
        // After learning more about mongodb , use agregate lookup,pipeline,match,group
        app.get('/available', async (req, res) => {
            ...
            services.forEach(service => {
                ...
                // step 5: slect slot for the service  Bookings: ['','','','']
                const bookedSlots = serviceBookings.map(book => book.slot)
                // step 6: select those slots that are not in in bookSlots
